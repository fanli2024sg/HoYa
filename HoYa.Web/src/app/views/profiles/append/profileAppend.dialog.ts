...
@Component({
    ...
    templateUrl: "profileAppend.dialog.html",
    styleUrls: ["profileAppend.dialog.css"],
    providers: [
        ProfilesService
    ]
})
export class ProfileAppendDialog {
    withRefresh = false;
    filteredProfiles$: Observable<Profile[]>;
    private anyLike$ = new Subject<string>();
    constructor(
        private matSnackBar: MatSnackBar,
        private dialogRef: MatDialogRef<ProfileAppendDialog>,
