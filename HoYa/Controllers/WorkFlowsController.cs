...
namespace HoYa.Controllers
{
    ...
    public class WorkFlowsController : ApiController
    {
        ...
        {
            IQueryable<WorkFlow> workFlows = db.WorkFlows.Where(x => (x.Value.Contains(anyLike) || anyLike == null) ||
        ...
        {
            return db.WorkFlows.Where(x => (x.Value.Contains(anyLike) || anyLike == null) ||
                           (x.Code.Contains(anyLike) || anyLike == null));
        }
